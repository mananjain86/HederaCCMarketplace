      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-10 py-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          ...
          <div className="max-w-md">
            <div className="flex items-center space-x-2 mb-3">
              ...
              <span className="text-2xl font-bold text-[#1b4332]">CarbonChain</span>
            </div>
          ...
          <div className="flex gap-16">
            <div>
              <h3 className="text-lg font-semibold text-[#1b4332] mb-3">Resources</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-[#1b4332] mb-3">Company</h3>
              <ul className="space-y-1 text-[#3a5a40]">
                <li
        ...
        <div className="border-t border-[#e8f1ea] mt-8 pt-6 text-center">
          <p className="text-[#3a5a40] text-sm">
            ...
            <span className="text-[#4a6741]">Hedera</span>, powered by blockchain technology.
          </p>
        </div>
      </div>
    </footer>
